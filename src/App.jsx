          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            <div className="hidden md:block relative">
              <div className="w-full aspect-square bg-gray-900 border border-lime-500/30 rounded-lg relative z-10 
                ...
                <img src="/Portfolio_image.jpeg" alt="Hiten Garg" className="w-full h-full object-cover rounded-lg relative z-10" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-20">
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-center group">
              <div className="w-full lg:w-7/12 relative">
                ...
                <div className="aspect-video bg-gray-900 border border-white/10 rounded-xl overflow-hidden flex items-center justify-center relative">
                   <img src="/Agrisphere.png" alt="AgriSphere Preview" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            ...
            <div className="flex flex-col lg:flex-row-reverse gap-8 items-center group">
              ...
              <div className="w-full lg:w-5/12 flex flex-col items-start text-left">
                ...
                <div className="flex gap-4">
                  <a href="https://assignmentmanagement-85g0.onrender.com/" target="_blank" rel="noreferrer" className="text-gray-300 hover:text-cyan-400 transition-colors flex items-center gap-2 text-sm font-medium">
                    <ExternalLink size={20} /> Live Demo
                  </a>
                  <a href="https://github.com/hitencodesdev/AssignmentManagement" target="_blank" rel="noreferrer" className="text-gray-300 hover:text-lime-400 transition-colors">
                    <Github size={20} />
                  </a>
                </div>
              </div>
